...
// argv[3] - WORKLOAD3
// argv[4] - WORKLOAD4
// argv[5] - QUANTUM - NOT NECESSARY FOR FCFS, argument isn't used
...
int main(int argc, char const *argv[]) {
    ...
    // - NOT NECESSARY FOR FCFS, argument isn't used
	...
	*************************************************************************************************/
	...
	/************************************************************************************************
		...
		- Below is First Come First Serve 
