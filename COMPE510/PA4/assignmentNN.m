...
beta1 = rand(num_hidden, m+1) * 0.5 - 0.25; % weights associated with links between input and hidden layers
beta2 = rand(num_output, num_hidden+1) * 0.5 - 0.25; % weights associated with links between hidden and output layers
% ============================================================
...
xn_new = zeros(1, length(x_new));
for i = 1:length(x_new)
    if sigma(i) ~= 0
        xn_new(i) = (x_new(i) - mu(i)) / sigma(i);
    end
end

y_new = predict(beta1, beta2, xn_new);
